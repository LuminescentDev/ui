...
- add active for mobile click events ([52085c9](https://github.com/LuminescentDev/ui/commit/52085c91ce6665df2293c2880525980566822e7f))
- add lum-bg utility for enhanced background and border styling ([06e56fa](https://github.com/LuminescentDev/ui/commit/06e56fa69d36fb185cb326e7654037e1f4006b12))
- add more color variables ([6bee32e](https://github.com/LuminescentDev/ui/commit/6bee32ead78a3e6fcbc70da60807e0d10609a937))
- add release workflows and configuration ([3c6a613](https://github.com/LuminescentDev/ui/commit/3c6a6134a27d8c84d2d90f62bc6b89f46be33959))
...
- enhance lum-toggle-bg utility with depth-based border and shadow effects ([d43c716](https://github.com/LuminescentDev/ui/commit/d43c7167adb4cbe98ec86ae01d2cc7cf46021c1c))
...
- **lum-bg:** make focus state depth-aware with fading border and shadow ([87a97dc](https://github.com/LuminescentDev/ui/commit/87a97dce8e7817d289adcb57df5a80d85118dcd4))
- **lum-btn:** add gap to lum-btn-p-\* utility for consistent button spacing ([6d022a4](https://github.com/LuminescentDev/ui/commit/6d022a4c214b60eb56616cd238c30b2d56b6e997))
- **lum-btn:** make button gap scalable via --lum-btn-gap-scale and remove hardcoded gap ([15f68d0](https://github.com/LuminescentDev/ui/commit/15f68d04868f1f9c652d3d7b10a12712c3c3722c))
- **lum-btn:** use clamp-based scaling for gap in lum-btn-p-\* utility, removing --lum-btn-gap-scale ([8bd2ac3](https://github.com/LuminescentDev/ui/commit/8bd2ac3751503426972f1939023fbbd5823de49c))
...
- **styles:** simplify focus border color for consistency ([a6d3fec](https://github.com/LuminescentDev/ui/commit/a6d3fec641e9046a5c0a174da1d80ad0e2ea8806))
...
- **styles:** update focus styles for improved visibility and consistency ([9fe48cb](https://github.com/LuminescentDev/ui/commit/9fe48cbcba8b237e1cbef48eeee35450f5d279cc))
...
- trigger erp ([d7d627d](https://github.com/LuminescentDev/ui/commit/d7d627dd280df85d363cc9c1630e2980beec07bb))
